...
// }
// else {
//     console.log(" Không có loại này ở đây");
// }
// //1.4 ;
...
//     }
// }
// else if(nhacungcap === "phukienso"){
//     console.log("1.5----------------------------");
//     console.log(`Name : ${arr[0].Name}`);
//     console.log(`Brand : ${arr[0].Brand}`);
//     console.log(`Price : ${arr[0].Price}`);
//     console.log(`Color : ${arr[0].Color}`);
//     console.log(`Category : ${arr[0].Category}`);
//     console.log(` Providers : ${arr[0].Providers}`);
// }
// else{
//     console.log(" Không có nhà cung cấp đó ở đây");
// }
